...
def lambda_handler(event, context):
    ...
    try:
        ...
        # Track total processed images across all records
        ...
        for record in event['Records']:
            ...
            # Prevent infinite loop: skip if event is from processed bucket
            if bucket == processed_bucket:
                logger.warning(f"Skipping image from processed bucket: {key}")
                continue
        ...
        return {
            ...
            'body': json.dumps({
                ...
                'processed_images': total_processed_count
            })
        }
